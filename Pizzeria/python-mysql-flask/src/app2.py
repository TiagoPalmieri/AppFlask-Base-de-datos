...
def edit(nro_pedido):
    ...
    if Nombre and Direccion and Telefono and tipo and cantidad and bebida and variedad:
        ...
        sql = "UPDATE pedido SET Nombre = %s, Direccion = %s, Telefono = %s, tipo = %s, cantidad = %s, precioFinal = %s , variedad = %s, bebida = %s WHERE nro_pedido = %s"
        data = (Nombre, Direccion, Telefono, tipo, cantidad, nuevo_precioFinal, variedad, bebida, nro_pedido)
        cursor.execute(sql, data)
        db.database.commit()
